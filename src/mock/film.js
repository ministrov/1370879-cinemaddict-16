...
const generatePoster = () => {
    ...
    const randomIndex = getRandomInteger(0, postors.length - 1);
    return postors[randomIndex];
}
...
export const generateFilm = () => ({
    ...
    genre: ['action', 'drama', 'comedy', 'sci-fy'],
    year: 2010,
    comment: comments[getRandomInteger(0, 2)],
    ratio: getRandomInteger(0, 10),
});